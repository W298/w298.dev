...
![300px](/imgs/post_imgs/unity_asm_def/1.png)

위의 경우 Universal 폴더에 있는 스크립트들을 지정하기 위해서 폴더 안에 `ASM-Universal.asmdef` 파일을 생성했다.

![500px](/imgs/post_imgs/unity_asm_def/4.png)
...
![400px](/imgs/post_imgs/unity_asm_def/2.png)
...
![400px](/imgs/post_imgs/unity_asm_def/3.png)
