...
function CircleIcon({ bgColor, icon, iconSize = 1, fill = "white" }) {
  return (
    <Flex
      ...
      transform={{ base: "scale(0.8)", sm: "scale(0.8)", md: "scale(1)" }}
  ...
  return (
    <Flex p={8} py={12} justifyContent="center">
      <DemonCardContainer>
        ...
        <Flex
          gap={{ base: "1.25rem", sm: "1.25rem", md: "1.5rem" }}
          justifyContent="space-evenly"
          alignItems="center"
          flexWrap="wrap"
        >
          <DemonCard>
            <Flex justifyContent="center" alignItems="center" gap="0.75rem">
              <BiWindowAlt />
              <Text
                fontFamily="Kanit"
                fontWeight="semibold"
          ...
          <DemonCard>
            ...
            <Flex gap={{ base: "0.2rem", sm: "0.2rem", md: "0.5rem" }}>
              ...
              <CircleIcon bgColor="#F7DF1E" icon={DiJavascript1} fill="black" />
